      ...
      <main className="container max-w-3xl mx-auto py-12">
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-6 mb-8 flex gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-purple-800">
              Please read this disclaimer carefully before using this website and participating in the TimeBucks platform.
            </p>
          </div>
        </div>
        ...
        <div className="prose prose-sm max-w-none text-gray-700">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              <strong>This is not a guarantee of earnings.</strong> Participation in the TimeBucks platform does not guarantee any specific income, earnings, or financial results. Your ability to earn depends on many factors including, but not limited to: the number and quality of surveys available to you, your eligibility for specific surveys, the time you invest, and your location.
            </p>
            <p className="mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              This website is a prelanding page that directs you to the TimeBucks platform. TimeBucks is a third-party service, and we are not responsible for their operations, policies, or practices. Please review TimeBucks's own Terms of Service and Privacy Policy before participating.
            </p>
            <p className="mb-4">
              We are not affiliated with, endorsed by, or sponsored by TimeBucks, except as a referral partner.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              You must be at least 18 years old to participate in the TimeBucks platform. By accessing this website and proceeding with qualification, you represent that you are at least 18 years old.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              The TimeBucks platform is available in select countries. Availability may vary based on your location. We are not responsible for determining your eligibility based on geographic location. TimeBucks will verify your eligibility during the qualification process.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              If you have questions about this disclaimer, please contact us using the information on our <Link href="/contact" className="text-purple-600 hover:text-purple-700">contact page</Link>.
            </p>
          </section>
        </div>
