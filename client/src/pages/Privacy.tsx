        ...
        <div className="prose prose-sm max-w-none text-gray-700">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside mb-4 space-y-2">
              ...
              <li>With the TimeBucks platform to process your qualification and participation</li>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              If you have questions or comments about this Privacy Policy, please contact us using the information provided on our <Link href="/contact" className="text-purple-600 hover:text-purple-700">contact page</Link>.
            </p>
          </section>
